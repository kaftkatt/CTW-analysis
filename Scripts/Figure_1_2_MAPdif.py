...
data_dirWITH = '/data/SO2/sio-kramosmusalem/exp06_512x612x100_ORL_SVB/01_SVB_febTS_output'
data_dirNO = '/data/SO2/sio-kramosmusalem/exp06_512x612x100_ORL/01_noSVB_febTS'

dsworg = open_mdsdataset(data_dirWITH, data_dirWITH, prefix=['eta'], default_dtype='>f4', levels=levels)
dsnorg = open_mdsdataset(data_dirNO, data_dirNO, prefix=['eta'], default_dtype='>f4', levels=levels)
...
pc = ax.contourf(LON, LAT, np.ma.masked_array(depth, mask=mask), 50, cmap=cmo.cm.deep) 
...
plt.savefig('/home/athelandersson/CTW-analysis/Figures/mapDIF.png')
